...
main(int argc,char *argv[])
{
  ...
  44:	7e050513          	addi	a0,a0,2016 # 820 <malloc+0x102>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d0:	48450513          	addi	a0,a0,1156 # 850 <digits>
 3d4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	3b8b8b93          	addi	s7,s7,952 # 850 <digits>
 ...
 5dc:	27090913          	addi	s2,s2,624 # 848 <malloc+0x12a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a4:	1c87b783          	ld	a5,456(a5) # 868 <freep>
 ...
 6d2:	00e6ea63          	bltu	a3,a4,6e6 <free+0x50>
{
 ...
 714:	14f73c23          	sd	a5,344(a4) # 868 <freep>
}
 718:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 746:	12653503          	ld	a0,294(a0) # 868 <freep>
 ...
 76e:	0fe90913          	addi	s2,s2,254 # 868 <freep>
  if(p == (char*)-1)
 772:	5afd                	li	s5,-1
 774:	a88d                	j	7e6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 776:	00000797          	auipc	a5,0x0
 77a:	0fa78793          	addi	a5,a5,250 # 870 <base>
 77e:	00000717          	auipc	a4,0x0
 782:	0ef73523          	sd	a5,234(a4) # 868 <freep>
 786:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a8:	0ca73223          	sd	a0,196(a4) # 868 <freep>
      return (void*)(p + 1);
