...
forktest(void)
{
  ...
  3e:	41650513          	addi	a0,a0,1046 # 450 <sigreturn+0xc>
  ...
  68:	3fc50513          	addi	a0,a0,1020 # 460 <sigreturn+0x1c>
  ...
  b8:	3fc50513          	addi	a0,a0,1020 # 4b0 <sigreturn+0x6c>
  ...
  d4:	3b050513          	addi	a0,a0,944 # 480 <sigreturn+0x3c>
  ...
  ee:	3ae50513          	addi	a0,a0,942 # 498 <sigreturn+0x54>
